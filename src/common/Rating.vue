<template>
  <div class="rating" v-if="rating">
    ...
    <template v-else>
      <template v-for="(n,index) in full" >
        <span class="star-full" :key="index"></span>
      </template>
      <template v-for="(n,index) in half">
        <span class="star-half" :key="index"></span>
      </template>
      <template v-for="(n,index) in gray">
        <span class="star-gray" :key="index"></span>
      </template>
